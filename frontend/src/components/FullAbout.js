  ...
  return (
    ...
    <div  style={{marginBottom:"150px"}}>
        ...
        <div className='fullabout_details'>
            <h3 style={{padding:"20px 150px 4px 150px",fontSize:"19px"}}>RoomFinder is the first company in Nepal that delivers food from hundreds of popular restaurants. As a pioneer food delivery service provider, we are making life easier through online ordering.</h3>
