...
export const saveRoom = (req,res)=>{
    ...
    file.mv(`./public/images/${fileName}`, async(err)=>{
        ...
        try {
            await Room.create({name:name,location:location,price:price,service:service,email:email,contact:contact,image: fileName,url:url});
...
export const updateRoom = async(req,res)=>{
    const room = await Room.findOne(
        ...
        const url = `${req.protocol}://${req.get("host")}/images/${fileName}`;
        try {
            await Room.update({name:name,location:location,price:price,service:service,email:email,contact:contact,image: fileName,url:url},{
                where:{
                    id:req.params.id
                }
            });
